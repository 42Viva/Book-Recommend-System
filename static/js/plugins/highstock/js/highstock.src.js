...
// encapsulated variables
    ...
    defaultOptions = {
        ...
        global: {
            ...
            VMLRadialGradientURL: 'http://code.highcharts.com/stock/4.2.4/gfx/vml-radial-gradient.png'
        },
        chart: {
            //animation: true,
            //alignTicks: false,
    ...
    SVGElement.prototype = {
        ...
        colorGradient: function (color, prop, elem) {
            ...
            if (gradName) {
                ...
                // Correct the radial gradient for the radial reference user
    ...
    */
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        /**
         * Translate each point to the plot area coordinate user and find shape positions
         */
        translate: function () {
            var series = this,
                chart = series.chart,
